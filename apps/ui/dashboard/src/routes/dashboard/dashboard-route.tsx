...
import { QueryResponse, RequestState } from '@archie/ui/shared/data-access/archie-api/interface';
...
export const DashboardRoute: FC = () => {
  ...
  const isMfaSet = queryResponse.state === RequestState.SUCCESS && queryResponse.data.mfaEnrollmentStage;
