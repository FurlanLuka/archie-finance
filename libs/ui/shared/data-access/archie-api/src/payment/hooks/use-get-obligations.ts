  ...
  const queryResponse = useExtendedQuery(
    ...
    async (accessToken: string) => {
      ...
      return {
        ...
        fullBalance:
          obligationsResponse.outstandingBalances.outstandingTotalAmount,
        interestOwed:
          obligationsResponse.outstandingBalances.outstandingInterestAmount,
      };
    },
  );
