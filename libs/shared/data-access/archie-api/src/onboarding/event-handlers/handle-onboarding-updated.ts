...
export const handleOnboardingUpdatedEvent = (event: OnboardingUpdatedWsEvent): void => {
  queryClient.setQueryData<GetOnboardingResponse>(ONBOARDING_RECORD_QUERY_KEY, event.data);
};
