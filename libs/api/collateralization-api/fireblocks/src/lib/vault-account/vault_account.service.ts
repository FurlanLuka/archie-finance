...
import { AssetList } from '../../../../data-transfer-objects/src';

@Injectable()
export class VaultAccountService {
  constructor(
    @InjectRepository(VaultAccount)
    private vaultAccount: Repository<VaultAccount>,
    @InjectRepository(DepositAddress)
    private depositAddress: Repository<DepositAddress>,
  ...
  public async getOrCreateVaultAccount(
    ...
    const vaultAccount: VaultAccount | null = await this.vaultAccount.findOneBy(
      {
        userId,
      },
    );
  ...
  public async createDepositAddress(
    ...
    const vaultAccount: VaultAccountResponse =
      this.getOrCreateVaultAccount(userId);
  ...
  public async getUserVaultAccount(
    ...
    const userVaultAccount: VaultAccount | null =
