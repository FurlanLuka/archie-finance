...
import { CollateralAsset, collateralAssets } from '@archie-webapps/archie-dashboard/util-constants';
...
export const CollateralCurrencySelect: FC<InputSelectProps> = ({ selectedAsset, setSelectedAsset }) => {
