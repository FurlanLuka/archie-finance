...
import { InputRange, ParagraphS, ParagraphXS, SubtitleM } from '@archie-webapps/shared/ui/design-system';
        ...
        <div className="address-code">
          ...
          <div className="info">
            <div className="info-group">
              <ParagraphXS>
                <Trans components={{ b: <b /> }} values={{ selected_collateral_asset: selectedCollateralAsset?.short }}>
