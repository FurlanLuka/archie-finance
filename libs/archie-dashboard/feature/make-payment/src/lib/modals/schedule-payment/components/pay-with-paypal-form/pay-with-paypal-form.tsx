...
import { PayWithPaypalFormData, getPayWithPaypalFormSchema } from './pay-with-paypal-form.schema';
...
export const PayWithPaypalForm: FC<PayWithPaypalFormProps> = ({ obligations, kycData, onConfirm }) => {
  ...
  return (
    <PayWithPaypalFormStyled>
      <TitleS className="title">{t('payment_modal.pay_with_paypal_form.title')}</TitleS>
